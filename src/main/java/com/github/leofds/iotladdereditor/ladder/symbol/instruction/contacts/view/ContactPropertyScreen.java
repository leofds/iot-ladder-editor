 ...
 ******************************************************************************/
package com.github.leofds.iotladdereditor.ladder.symbol.instruction.contacts.view;
...
public class ContactPropertyScreen extends DialogScreen{
	...
	public ContactPropertyScreen(String title,DeviceMemory memory) {
		super(title);
		this.memory = memory;
		...
		JLabel lbOutput = new JLabel(Strings.input()+":",SwingConstants.RIGHT);
