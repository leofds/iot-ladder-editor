...
public class ResetCoil extends CoilInstruction{
	...
	public void paint(Graphics2D g2d){
		...
		int len = g2d.getFontMetrics().stringWidth("R");
		g2d.drawString("R", (blockWidth-len)/2, blockHeight/1.7f);
	}
	...
	public String toString() {
		return "instruction=(R), " + super.toString();
	}
}
