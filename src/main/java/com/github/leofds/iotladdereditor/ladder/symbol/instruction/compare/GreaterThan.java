...
public class GreaterThan extends CompareInstruction{
	...
	public List<Quadruple> generateIR(GenContext context) {
		...
		quadruples.add( QuadrupleFactory.createIfG(sourceA, sourceB, label1) );
	...
	public String toString() {
		return "instruction=G, " + super.toString();
	}
}
