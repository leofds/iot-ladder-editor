...
public class LessEqual extends CompareInstruction{
	...
	public List<Quadruple> generateIR(GenContext context) {
		...
		quadruples.add( QuadrupleFactory.createIfLE(sourceA, sourceB, label1) );
	...
	public String toString() {
		return "instruction=LEQ, " + super.toString();
	}
}
