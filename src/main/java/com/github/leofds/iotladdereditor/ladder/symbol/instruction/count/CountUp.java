...
public class CountUp extends CountInstruction{
	...
	public List<Quadruple> generateIR(GenContext context) {
		...
		quadruples.add( QuadrupleFactory.createAdd(accumValue, one, accumValue) );
		quadruples.add( QuadrupleFactory.createAssignment(one, countValue) );
		quadruples.add( QuadrupleFactory.createIfL(accumValue, presetValue, label2) );
	...
	public String toString() {
		return "instruction=CNT UP, " + super.toString();
	}
}
