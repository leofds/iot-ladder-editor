...
public class PositiveTransitionContact extends ContactInstruction {

	private static final long serialVersionUID = 1L;
	
	private DeviceMemory lastValue = new DeviceMemory();
	
	public PositiveTransitionContact() {
		super();
		setLabel("|P|");
	}
	...
	public void paint(Graphics2D g2d){
		...
		int len = g2d.getFontMetrics().stringWidth("P");
		g2d.drawString("P", (blockWidth-len)/2, blockHeight/1.7f);
	}
	...
	public List<Quadruple> generateIR(GenContext context) {
		...
		quadruples.add( QuadrupleFactory.createIf(lastValue, label) );
	...
	public String toString() {
		return "instruction=|P|, " + super.toString();
	}
}
