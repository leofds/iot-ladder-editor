...
public class Assignment extends OperatorInstruction{
	...
	public void paint(Graphics2D g2d){
		...
		g2d.drawString("Value", (blockWidth)/4, blockHeight*getHeight()/2f);
	...
	public List<Quadruple> generateIR(GenContext context) {
		...
		quadruples.add(QuadrupleFactory.createAssignment(sourceA , destiny));
	...
	public String toString() {
		return "instruction=ASSIGNMENT, " + super.toString();
	}
}
