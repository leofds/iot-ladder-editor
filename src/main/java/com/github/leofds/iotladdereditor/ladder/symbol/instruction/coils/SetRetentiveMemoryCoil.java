...
public class SetRetentiveMemoryCoil extends CoilInstruction{

	private static final long serialVersionUID = 1L;

	public SetRetentiveMemoryCoil() {
		super();
		setLabel("(SM)");
	}
	...
	public void paint(Graphics2D g2d){
		...
		int len = g2d.getFontMetrics().stringWidth("SM");
		g2d.drawString("SM", (blockWidth-len)/2, blockHeight/1.7f);
	}
	...
	public String toString() {
		return "instruction=(SM), " + super.toString();
	}
}
