...
public class RetentiveMemoryCoil extends CoilInstruction{

	private static final long serialVersionUID = 1L;

	public RetentiveMemoryCoil() {
		super();
		setLabel("(M)");
	}
	...
	public void paint(Graphics2D g2d){
		...
		int len = g2d.getFontMetrics().stringWidth("M");
		g2d.drawString("M", (blockWidth-len)/2, blockHeight/1.7f);
	}
	...
	public String toString() {
		return "instruction=(M), " + super.toString();
	}
}
